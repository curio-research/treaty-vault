...
export interface PositionComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValue((uint256,uint256))" | "getValue" | "has" | "remove" | "set(uint256,bytes)" | "set(uint256,(uint256,uint256))"): FunctionFragment;
