...
export interface BoolComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesWithValue(bool)" | "getEntitiesWithValue(bytes)" | "getValue" | "has" | "remove" | "set(uint256)" | "set(uint256,bytes)"): FunctionFragment;
