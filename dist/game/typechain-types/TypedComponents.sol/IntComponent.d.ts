...
export interface IntComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValue(int256)" | "getValue" | "has" | "remove" | "set(uint256,int256)" | "set(uint256,bytes)"): FunctionFragment;
