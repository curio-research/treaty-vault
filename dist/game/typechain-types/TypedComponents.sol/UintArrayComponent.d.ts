...
export interface UintArrayComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesWithValue(uint256[])" | "getEntitiesWithValue(bytes)" | "getValue" | "has" | "remove" | "set(uint256,bytes)" | "set(uint256,uint256[])"): FunctionFragment;
