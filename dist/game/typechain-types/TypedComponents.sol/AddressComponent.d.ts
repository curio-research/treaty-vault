...
export interface AddressComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesWithValue(address)" | "getEntitiesWithValue(bytes)" | "getValue" | "has" | "remove" | "set(uint256,address)" | "set(uint256,bytes)"): FunctionFragment;
