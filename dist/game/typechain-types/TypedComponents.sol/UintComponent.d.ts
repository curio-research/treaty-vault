...
export interface UintComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValue(uint256)" | "getValue" | "has" | "remove" | "set(uint256,uint256)" | "set(uint256,bytes)"): FunctionFragment;
