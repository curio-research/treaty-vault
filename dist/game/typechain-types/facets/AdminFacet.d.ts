...
export interface AdminFacetInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addEntity" | "bulkInitializeTiles" | "reactivatePlayer" | "registerComponents" | "registerDefaultComponents" | "setComponentValue" | "storeEncodedColumnBatches"): FunctionFragment;
