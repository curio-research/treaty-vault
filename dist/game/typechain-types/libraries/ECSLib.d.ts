...
export interface ECSLibInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'concatenate' | 'difference' | 'getAddress' | 'getAddressComponent' | 'getBool' | 'getBoolComponent' | 'getComponent' | 'getComponentByEntity' | 'getComponentValue' | 'getInt' | 'getIntComponent' | 'getPosition' | 'getPositionComponent' | 'getString' | 'getStringComponent' | 'getUint' | 'getUintArray' | 'getUintArrayComponent' | 'getUintComponent'): FunctionFragment;
...
export declare type ComponentValueRemovedEvent = TypedEvent<[string, BigNumber], ComponentValueRemovedEventObject>;
...
export declare type ComponentValueSetEvent = TypedEvent<[string, BigNumber, string], ComponentValueSetEventObject>;
...
export declare type EntityRemovedEvent = TypedEvent<[BigNumber], EntityRemovedEventObject>;
export declare type EntityRemovedEventFilter = TypedEventFilter<EntityRemovedEvent>;
export interface NewComponentEventObject {
    _name: string;
    _entity: BigNumber;
}
export declare type NewComponentEvent = TypedEvent<[string, BigNumber], NewComponentEventObject>;
