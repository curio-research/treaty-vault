...
export interface GameLibInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'adjacent' | 'adjacentToCity' | '_barbarianInfantrySelector' | 'coincident' | 'connected' | 'euclidean' | 'getBattleDamages' | 'getCityTileCountByLevel' | 'getMapTileAt' | 'getNeighbors' | 'getPlayer' | 'getSettlerHealthAndSpeedByLevel' | '_goldLevelSelector' | 'inBound' | 'random' | 'strEq' | 'sum' | 'withinDistance' | 'activePlayerCheck' | 'entityOwnershipCheck' | 'ongoingGameCheck' | 'inboundPositionCheck' | 'validEntityCheck'): FunctionFragment;
...
export interface GameLib extends BaseContract {
    ...
    functions: {
        ...
        getBattleDamages(_army1: PromiseOrValue<BigNumberish>, _army2: PromiseOrValue<BigNumberish>, _duration: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            _damageOn1: BigNumber;
            _damageOn2: BigNumber;
        }>;
