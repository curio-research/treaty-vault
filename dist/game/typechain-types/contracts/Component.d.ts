...
export interface ComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesAsSet" | "getEntitiesWithValue" | "getEntitiesWithValueAsSet" | "has" | "remove" | "set"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: "set", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
...
export interface Component extends BaseContract {
    ...
    functions: {
        ...
        getEntitiesWithValue(_value: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[BigNumber[]]>;
        ...
        set(_entity: PromiseOrValue<BigNumberish>, _value: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    getAllEntitiesAndValues(overrides?: CallOverrides): Promise<[BigNumber[], string[]]>;
    ...
    callStatic: {
        ...
        set(_entity: PromiseOrValue<BigNumberish>, _value: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
    ...
    populateTransaction: {
        ...
        getEntitiesWithValue(_value: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
