...
export interface DiamondInitInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "init", values: [WorldConstantsStruct]): string;
...
export interface DiamondInit extends BaseContract {
    ...
    functions: {
        init(_worldConstants: WorldConstantsStruct, overrides?: Overrides & {
    ...
    callStatic: {
        init(_worldConstants: WorldConstantsStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        init(_worldConstants: WorldConstantsStruct, overrides?: Overrides & {
