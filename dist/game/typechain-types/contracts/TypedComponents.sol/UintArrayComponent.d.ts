...
export interface UintArrayComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesAsSet" | "getEntitiesWithValue(uint256[])" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValueAsSet" | "getValue" | "has" | "remove" | "set(uint256,bytes)" | "set(uint256,uint256[])"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getEntitiesWithValue(uint256[])", values: [PromiseOrValue<BigNumberish>[]]): string;
    ...
    encodeFunctionData(functionFragment: "set(uint256,uint256[])", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>[]]): string;
    ...
    decodeFunctionResult(functionFragment: "getEntitiesWithValue(uint256[])", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "set(uint256,uint256[])", data: BytesLike): Result;
    events: {};
}
export interface UintArrayComponent extends BaseContract {
    ...
    functions: {
        ...
        "getEntitiesWithValue(uint256[])"(_value: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<[BigNumber[]]>;
        ...
        "set(uint256,uint256[])"(_entity: PromiseOrValue<BigNumberish>, _value: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    getAllEntitiesAndValues(overrides?: CallOverrides): Promise<[BigNumber[], string[]]>;
    ...
    callStatic: {
        ...
        "set(uint256,uint256[])"(_entity: PromiseOrValue<BigNumberish>, _value: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
    ...
    populateTransaction: {
        ...
        "getEntitiesWithValue(uint256[])"(_value: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
