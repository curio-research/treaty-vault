...
export interface StringComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesAsSet" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValue(string)" | "getEntitiesWithValueAsSet" | "getValue" | "has" | "remove" | "set(uint256,string)" | "set(uint256,bytes)"): FunctionFragment;
