...
export interface BoolComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesAsSet" | "getEntitiesWithValue(bool)" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValueAsSet" | "getValue" | "has" | "remove" | "set(uint256)" | "set(uint256,bytes)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getEntitiesWithValue(bool)", values: [PromiseOrValue<boolean>]): string;
    ...
    encodeFunctionData(functionFragment: "set(uint256)", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "getEntitiesWithValue(bool)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "set(uint256)", data: BytesLike): Result;
...
export interface BoolComponent extends BaseContract {
    ...
    functions: {
        ...
        "getEntitiesWithValue(bool)"(_value: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[BigNumber[]]>;
        ...
        getValue(_entity: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        "set(uint256)"(_entity: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "set(uint256)"(_entity: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        "getEntitiesWithValue(bool)"(_value: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
