...
export interface AddressComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesAsSet" | "getEntitiesWithValue(address)" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValueAsSet" | "getValue" | "has" | "remove" | "set(uint256,address)" | "set(uint256,bytes)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getEntitiesWithValue(address)", values: [PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: "set(uint256,address)", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "getEntitiesWithValue(address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "set(uint256,address)", data: BytesLike): Result;
...
export interface AddressComponent extends BaseContract {
    ...
    functions: {
        ...
        "getEntitiesWithValue(address)"(_value: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber[]]>;
        ...
        "set(uint256,address)"(_entity: PromiseOrValue<BigNumberish>, _value: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "set(uint256,address)"(_entity: PromiseOrValue<BigNumberish>, _value: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        "getEntitiesWithValue(address)"(_value: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
