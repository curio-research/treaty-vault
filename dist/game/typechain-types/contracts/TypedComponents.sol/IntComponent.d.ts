...
export interface IntComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesAsSet" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValue(int256)" | "getEntitiesWithValueAsSet" | "getValue" | "has" | "remove" | "set(uint256,int256)" | "set(uint256,bytes)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getEntitiesWithValue(int256)", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "set(uint256,int256)", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "getEntitiesWithValue(int256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "set(uint256,int256)", data: BytesLike): Result;
...
export interface IntComponent extends BaseContract {
    ...
    functions: {
        ...
        "getEntitiesWithValue(int256)"(_value: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber[]]>;
        ...
        "set(uint256,int256)"(_entity: PromiseOrValue<BigNumberish>, _value: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "set(uint256,int256)"(_entity: PromiseOrValue<BigNumberish>, _value: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        "getEntitiesWithValue(int256)"(_value: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
