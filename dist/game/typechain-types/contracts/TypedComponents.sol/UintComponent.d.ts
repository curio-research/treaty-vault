...
export interface UintComponentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllEntitiesAndValues" | "getBytesValue" | "getEntities" | "getEntitiesAsSet" | "getEntitiesWithValue(bytes)" | "getEntitiesWithValue(uint256)" | "getEntitiesWithValueAsSet" | "getValue" | "has" | "remove" | "set(uint256,uint256)" | "set(uint256,bytes)"): FunctionFragment;
